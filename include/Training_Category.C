...
int BDT::TrainingCategory(TCut cutSB, TString MC_DVCS, TString MC_Pi0, vector<TString> vars)
{
  ...
  if (batchMode)
    factoryOptions += ":!Color:!DrawProgressBar";
  ...
  TCut mycutb = cutSB; // for example: TCut mycutb = "abs(var1)<0.5";
                       /*
                          if(!categories)
                          {
                           mycuts = cutSB + TCut("_strip_Ph_Theta > 5");
                           mycutb = cutSB + TCut("_strip_Ph_Theta > 5");
                          }
                        */
  ...
  if (categories)
  {
    ...
    // mcat->AddMethod( "_strip_Ph_Theta < 5 && strip_Nuc_Theta < 35", theCat1Vars, TMVA::Types::kBDT, "BDT_1",optBDT );
    // mcat->AddMethod( "_strip_Ph_Theta > 5 && strip_Nuc_Theta < 35", theCat2Vars, TMVA::Types::kBDT, "BDT_2",optBDT );
    // mcat->AddMethod( "_strip_Ph_Theta < 5 && strip_Nuc_Theta > 35", theCat3Vars, TMVA::Types::kBDT, "BDT_3",optBDT );
    // mcat->AddMethod( "_strip_Ph_Theta > 5 && strip_Nuc_Theta > 35", theCat4Vars, TMVA::Types::kBDT, "BDT_4",optBDT );
    // mcat->AddMethod( "_strip_Nuc_Theta < 35", theCat1Vars, TMVA::Types::kBDT, "BDT_1",optBDT );
    // mcat->AddMethod( "_strip_Nuc_Theta > 35", theCat2Vars, TMVA::Types::kBDT, "BDT_2",optBDT );
    mcat->AddMethod("_strip_Ph_Theta < 5", theCat1Vars, TMVA::Types::kBDT, "BDT_1", optBDT);
    mcat->AddMethod("_strip_Ph_Theta > 5", theCat2Vars, TMVA::Types::kBDT, "BDT_2", optBDT);
  }
  else
  {
